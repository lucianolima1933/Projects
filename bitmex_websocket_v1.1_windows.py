...
#  --- 26-02-2020: Release of the Script for Windows (same version)
#  ---             The Windows version has no 'dialog' library, using direct input
#  ---
...
# for Windows, the Dialog library is not working. I will try the simple Input() function.
try:
    import thread
except ImportError:
    import _thread as thread
...
e = input("Select the environment: \n [1] --> Production Environment \n [2] --> TESTNET Environment ")
if e=='1':
   mvalor2="(1)"
elif e=='2':
   mvalor2="(2)"
...
d = input("Enter the asset name (default XBTUSD):")
mvalor1 = d

print(f'Environment : {mvalor2}\n Asset: {mvalor1}')
